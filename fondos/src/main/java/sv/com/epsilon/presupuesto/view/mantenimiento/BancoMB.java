...
@ManagedBean
@ViewScoped
public class BancoMB extends AbstractMantto<Banco, BancoFacade> implements Serializable {
...
//
	...
	public void reset() {
		...
		this.setItemSelected(new Banco());
		setDefaultValue();
	...
	public void defineHeaders() {
		this.setHeaderDialog("Nueva Banco");
		this.setHeaderPage("Mantenimiento Bancos ");
		this.setHeaderTable("Bancos");
		this.setIdFormNew("idFormCreateBanco");
		this.setIdFormDelete("idFormDeleteCreateBanco");
		this.setIdFormList("idFormListBanco");
		this.setIdFormEdit("idFormEditBanco");
		this.setIdTable("idTablaBanco");
		this.setWtgDialog("wgtDlgBanco");
		this.setIdWtgNew("IdWgtDlgNewBanco");
		this.setDialogDelete("dltBancoWgt");
		this.setDialogEdit("WgtEditDlgBanco");
	...
	public void preRender() {
		...
		try {
			defineHeaders();
			initFacade();
			this.setList(((BancoFacade)getFacade()).findAllByEmpresa((Integer)usuarioSessionMB.getValue("idEmpresa")));
